...
const stats = [
  { icon: Users, value: "50,000+", labelKey: "stats_members", color: "text-saffron-500", bg: "bg-saffron-50" },
  { icon: Heart, value: "₹1 Cr+", labelKey: "stats_donations", color: "text-red-500", bg: "bg-red-50" },
  { icon: Calendar, value: "200+", labelKey: "stats_events", color: "text-blue-500", bg: "bg-blue-50" },
  { icon: Award, value: "1,000+", labelKey: "stats_volunteers", color: "text-green-500", bg: "bg-green-50" },
];
