...
const allEvents = [
  ...
  { id: 4,  emoji: "🇮🇳", type: "National",        color: "bg-green-600",   name: "स्वातंत्र्य दिन",       nameEn: "Independence Day",       date: "15 Aug 2026",           time: "08:00 AM",           venue: "Sector 20, Kharghar",       desc: "भारताच्या स्वातंत्र्याचा 79वा वर्धापन दिन — ध्वजारोहण, प्रभात फेरी व सांस्कृतिक कार्यक्रम.", image: "/images/independenceDay.PNG" },
  { id: 5,  emoji: "🏅", type: "National",         color: "bg-blue-700",    name: "प्रजासत्ताक दिन",      nameEn: "Republic Day",           date: "26 Jan 2027",           time: "08:00 AM",           venue: "Sector 20, Kharghar",       desc: "प्रजासत्ताक दिनानिमित्त ध्वजारोहण, मार्चपास्ट व प्रतिज्ञा कार्यक्रम.", image: "/images/REPUBLICDAY.jpg" },
  ...
  { id: 7,  emoji: "📚", type: "Social Welfare",   color: "bg-indigo-600",  name: "शालेय पुस्तक वाटप",    nameEn: "School Book Donation",   date: "Jun 2026",              time: "10:00 AM",           venue: "Kharghar Schools",          desc: "नवीन शैक्षणिक वर्षाच्या सुरुवातीला गरजू विद्यार्थ्यांना मोफत पाठ्यपुस्तके वाटप.", image: "/images/book_fest.jpeg" },
  { id: 8,  emoji: "🏥", type: "Medical",          color: "bg-green-700",   name: "वैद्यकीय शिबीर",       nameEn: "Medical Camp",           date: "TBD 2026",              time: "09:00 AM – 4:00 PM", venue: "Sector 20, Kharghar",       desc: "मोफत आरोग्य तपासणी शिबीर — रक्तदाब, साखर, डोळे, दात व सामान्य तपासणी.", image: "/images/medicalcamp.jpeg" },
              ...
              <article key={event.id} onClick={() => gate(() => router.push(`/events/${event.id}`))} className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 cursor-pointer">
                ...
                <div className="p-5">
                  ...
                  <div className="space-y-2 mb-5 text-sm text-gray-500">
                    <div className="flex items-center gap-2"><Calendar size={14} className="text-saffron-700" />{event.date}</div>
                    <div className="flex items-center gap-2"><Clock size={14} className="text-saffron-700" />{event.time}</div>
                    <div className="flex items-center gap-2"><MapPin size={14} className="text-saffron-700" />{event.venue}</div>
                  </div>
